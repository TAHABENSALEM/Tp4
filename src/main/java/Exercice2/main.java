...
Student student = new Student("student1", "student1", "student@email.com", 1523L, 15.0, Classes.IA1_2,Status.REDOUBLANT);
student.displayInfo();
student.updateProfile("student11", "student11", "john.doe.new@email.com", 2222L, 15.0, Classes.IA1_2,Status.NON_REDOUBLANT);
student.displayInfo();
